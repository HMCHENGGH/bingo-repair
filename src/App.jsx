        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              {/* Bingo Logo 图片 */}
              <img src="/logo.png" alt="三元建築工程有限公司" className="h-10 w-auto mr-3" />
              <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <h4 className="text-xl font-bold mb-2">電郵聯絡</h4>
            ...
            <div>
              ...
              <p className="text-gray-300">週一至周日 8:00-22:00</p>
              <p className="text-gray-400 text-sm">緊急服務24小時</p>
            </div>
            <div>
              ...
              <p className="text-gray-400 text-sm">微信号: hmc0985</p>
            </div>
          </div>
        </div>
      </section>
