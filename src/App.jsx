  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">三元維修</h1>
                <p className="text-sm text-gray-600">澳門專業持證師傅 • 平靚正服務</p>
              </div>
            </div>
            
            <div className="hidden md:flex items-center space-x-4">
              <div className="flex space-x-2">
                <button className="text-xs bg-gray-100 hover:bg-gray-200 px-2 py-1 rounded">粵</button>
                <button className="text-xs bg-gray-100 hover:bg-gray-200 px-2 py-1 rounded">簡</button>
          ...
          {isMenuOpen && (
            <div className="md:hidden py-4 border-t">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <a href="#about" className="text-gray-700 hover:text-blue-600 font-medium">關於我們</a>
      ...
      <section id="services" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">澳門專業持證師傅，專業解決各種家居維修需求</p>
          </div>
      ...
      <section className="bg-gray-100 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">澳門持證師傅</h3>
            <p className="text-gray-600 text-lg">專業資質 • 專業經驗 • 值得信賴</p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">澳門本地客戶評價</h3>
            <p className="text-gray-600 text-lg">來自澳門半島、氹仔、路環的真實回饋</p>
          </div>
      ...
      <section className="bg-blue-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">服務覆蓋澳門全境</h3>
            <p className="text-gray-600 text-lg">無論您在澳門哪個區域，我們都提供快速上門服務</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white rounded-xl shadow-lg">
              <MapPin className="w-12 h-12 text-blue-600 mx-auto mb-4" />
              <h4 className="text-xl font-bold text-gray-900 mb-2">澳門半島</h4>
              <p className="text-gray-600 mb-2">1-2小時內上門</p>
              <p className="text-sm text-gray-500">新葡京、葡京、議事亭前地、新馬路等</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-lg">
              <MapPin className="w-12 h-12 text-green-600 mx-auto mb-4" />
              <h4 className="text-xl font-bold text-gray-900 mb-2">氹仔</h4>
              <p className="text-gray-600 mb-2">1-2小時內上門</p>
              <p className="text-sm text-gray-500">官也街、威尼斯人、銀河、路氹城等</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-lg">
              <MapPin className="w-12 h-12 text-purple-600 mx-auto mb-4" />
              <h4 className="text-xl font-bold text-gray-900 mb-2">路環</h4>
              <p className="text-gray-600 mb-2">1-2小時內上門</p>
              <p className="text-sm text-gray-500">路環市區、黑沙海灘、竹灣等</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="bg-gray-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg">有任何問題或需要預約服務，請隨時聯繫我們</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-xl font-bold mb-2">緊急電話</h4>
              <p className="text-gray-300 text-lg font-bold">+853 6611 0985</p>
              <p className="text-gray-400 text-sm">24小時服務</p>
            </div>
            <div className="text-center">
              <div className="bg-green-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Mail className="w-8 h-8" />
              </div>
              <h4 className="text-xl font-bold mb-2">郵箱聯繫</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-bold mb-2">服務時間</h4>
              <p className="text-gray-300">週一至周日 8:00-22:00<br />緊急服務24小時</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Users className="w-8 h-8" />
              </div>
              <h4 className="text-xl font-bold mb-2">微信預約</h4>
              <p className="text-gray-300">搜索微信號預約</p>
              <p className="text-gray-400 text-sm">澳門用戶常用</p>
            </div>
          </div>
      ...
      <footer className="bg-gray-800 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p>&copy; 2025 三元維修. 保留所有權利.</p>
            <p className="text-gray-400 mt-2">澳門專業持證師傅 • 專業家居維修服務</p>
            <div className="flex justify-center space-x-4 mt-4">
              <span className="text-xs bg-gray-700 px-2 py-1 rounded">粵語</span>
              <span className="text-xs bg-gray-700 px-2 py-1 rounded">普通話</span>
